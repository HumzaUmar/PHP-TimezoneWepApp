    ...
    <head>
        ...
        <body>
            <header>
                <div class="container">
                    <div id="logo">
                        <h1>T - <span style="color:#008eed">Zone</span></a></h1> </div>
                    </div>
                </header>
                <div class="main-text">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <form method="post">
                                <input type="text" name="country_txt" style=" width: 350px; height: 50px; text-align: center; border-radius: 8px; " placeholder="Enter Location"> </div>
                                <div class="col-xs-12" style="margin-top:20px;">
                                    <div class="hint">
                                        <p>E.g(Berlin, Qatar, Tokyo)</p>
                                    </div>
                                    <button class="btn btn-default" title="Add Location" type="submit" name="submit_btn" style="height: 40px; border-radius: 10px;  background-color: #008eed; "> <i class="glyphicon glyphicon-plus" style="color: white;"></i> </button>
                                    <button class="btn btn-default" title="Current Location" type="submit" name="current_btn" style="height: 40px; border-radius: 10px;  background-color: #008eed; "> <i class="glyphicon glyphicon-user" style="color: white;"></i> </button>
                                    <button class="btn btn-default" title="Favourite Location" type="submit" name="fav_btn" style="height: 40px; border-radius: 10px; background-color: #008eed;"> <i class="glyphicon glyphicon-star" style="color: white;"></i> </button>
                                    <button class="btn btn-default" title="Reset Location" type="submit" name="reset_btn" style="height: 40px; border-radius: 10px; background-color: #008eed;"> <i class="glyphicon glyphicon-trash" style="color: white;"></i> </button>
                                </div>
                            </form>
                        </div>
                    </div>
